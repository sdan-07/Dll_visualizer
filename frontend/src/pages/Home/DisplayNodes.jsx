    ...
    <>
      <div className="w-full bg-white rounded-lg px-4 py-5 sm:py-6 border-slate-200 shadow-lg">
        <div className="py-14 sm:py-18 md:py-32 w-auto flex flex-col items-center justify-center">
          {nodes.length === 0 ? (
            <>
              <p className="text-gray-400 text-[22px] sm:text-[24px]">
            ...
            <div className="w-full flex items-center md:justify-center gap-0 sm:gap-3 md:gap-4 mx-auto overflow-x-auto whitespace-nowrap px-5">
              {nodes.map((node, idx) => (
                ...
                >
                  {/* node box */}
                  <div className={`px-5 py-3 rounded-lg relative `}>
                    <div
                      className={`bg-indigo-500 text-white rounded-lg px-10 py-4 sm:p-5 md:px-16 md:py-7 shadow-md w-20 sm:w-24 md:w-32 relative transition-all duration-300 ${
                    ...
                    >
                      <div className="flex flex-col justify-center items-center">
                        <div className="text-[10px] sm:text-base text-indigo-100 mb-0.5 sm:mb-1">
                          Value
                        </div>
                      ...
                      <div className="absolute bottom-1.5 left-1.5 sm:bottom-2 sm:left-2 text-[10px] sm:text-sm text-indigo-100">
                        {node.prev ? (
                          <span className="text-[13px] sm:text-2xl">←</span>
                        ) : (
                          "null"
                        )}
                      </div>
